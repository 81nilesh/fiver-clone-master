...
function Footer() {
  const socialLinks = [
    { name: "Github", icon: <FiGithub />, link: "https://github.com/81nilesh" },
    {
      name: "Youtube",
      icon: <FiYoutube />,
      link: "https://www.youtube.com/channel/UCqFFrpkeIFM8XM6qIVyyG6w",
    },
    {
      name: "LinkedIn",
      icon: <FiLinkedin />,
      link: "https://www.linkedin.com/in/nilesh-choudhary-993b06200/",
    },
    {
      name: "Instagram",
      icon: <FiInstagram />,
      link: "https://www.instagram.com/choudhary__nilesh_/",
    },
    {
      name: "Twitter",
      icon: <FiTwitter />,
